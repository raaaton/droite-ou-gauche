...
function randomInstruction() {
  ...
  if (random < 0.5) {
    instruction.innerText = "GAUCHE";
    boutonAAppuyer = 'arrowleft';
  } else {
    instruction.innerText = "DROITE";
...
function startTimer() {
    ...
    function updateTimer() {
      timerElement.innerText = "Temps : " + timeLeft;
      timeLeft--;
      if (timeLeft < 0) {
        clearInterval(timer);
        ...
        instructionElement.innerText = boutonAAppuyer === 'arrowleft' ? "GAUCHE" : "DROITE";
